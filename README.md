...
- **Meeting #7 - Jan 8th/`Notes_Questions for Dataset A`** - *Document with detailed steps regarding how to create a zero-loss construction for Dataset A, and how to fine-tune the MSE loss.*
- **Meeting #7 - Jan 8th/`Summary of All Experiments (prior to 1-15) - Project with Professor Chen, Patrícia, and Mayank`** - *Document that contains a summary of all the previous experiments, and contains sections about the purpose, methodology, and results of those experiments.*
